...
// TokenList class for each input
    $.TokenList = function (input, url_or_data, settings) {
        ...
        var filter = "Add Filter"
        var input_box = $("<input type=\"text\"  autocomplete=\"off\" value=\"Add Filter\" style=\"font-family: tahoma;color: #777777;font-size: 14px;\" class='input-tokenizer'>")
            .css({
                outline: "none"
        ...
        function insert_token(li_data, value) {
            var id = li_data.id;
            var callback = settings.onAdd;
            var this_token = $("<li><p>"+ value +"</p> </li>")
                .addClass(settings.classes.token)
                .appendTo($('#all-tokens ul'));
...
//        var callback = settings.onAdd;
            ...
            if(token_count > 0 && settings.preventDuplicates) {
                ...
                $('#all-tokens ul').children().each(function () {
...
//                input_box.focus();
            ...
            insert_token(li_data, li_data.name);
...
//        }
        ...
        function select_token (token) {
            ...
            $(token).effect("highlight", {color:'#D0ECFF'}, 5000);
...
//        input_box.focus();
        ...
        function show_dropdown() {
            if ($('#buttons').length)
            {
                $('div.token-input-dropdown-facebook').css("width",343.7)
            }
            else
            {
                $('div.token-input-dropdown-facebook').css("width",342.93)
            }
